...
namespace BootCamp.Chapter1
{
    static class Lesson5
    {
        ...
        {
            if (!IsNotNullAndEmpty(array)) return array;
        ...
        internal static int[] RemoveAt(int[] array, int index)
        {
            ...
            if (HasInvalidArguments) return array;
        ...
        {
            if (!IsNotNullAndEmpty(array)) return new int[1] { number };
        ...
        internal static int[] InsertAt(int[] array, int number, int index)
        {
            ...
            {
                if (index == 0 ) return new int[1] { number };
                return array;
            }
